 ...
 */
public class WallAdoptionFragment extends Fragment {
    ...
    public static WallAdoptionFragment newInstance(int position, int value) {
        WallAdoptionFragment fragment = new WallAdoptionFragment();
