...
public class PasswordEditText extends EditText {
    ...
    @DrawableRes
    private int showPwIcon = R.drawable.ic_password_on;

    @DrawableRes
    private int hidePwIcon = R.drawable.ic_password_off;
    ...
    public void initFields(AttributeSet attrs, int defStyleAttr) {
        ...
        hidePwDrawable =  VectorDrawableCompat.create(getResources(),hidePwIcon,null).mutate();//  ContextCompat.getDrawable(getContext(), hidePwIcon).mutate();
        showPwDrawable = VectorDrawableCompat.create(getResources(),showPwIcon,null).mutate();//ContextCompat.getDrawable(getContext(), showPwIcon).mutate();
